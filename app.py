...
# Sayfa Ayarları
st.set_page_config(page_title="Study-Buddy v3.7", page_icon="✈️")
...
# Form sayesinde Enter'a basınca içi boşalır
with st.form(key='my_form', clear_on_submit=True):
    st.text_input("Meaning:", key="ans_input")
    submit_button = st.form_submit_button(label='SEND ANSWER', on_click=handle_submit)
